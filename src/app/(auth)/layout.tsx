...
export default function AuthLayout({ children }: React.PropsWithChildren) {
  return (
    <div className="relative grid min-h-screen grid-cols-1 lg:grid-cols-2">
      ...
      <main className="flex w-full items-center justify-center p-4 lg:static lg:left-0 lg:top-0 lg:flex lg:translate-x-0 lg:translate-y-0">
        {children}
      </main>
      <div className="relative hidden lg:block lg:aspect-video lg:size-full">
        <Image
